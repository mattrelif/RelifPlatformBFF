...
type Housings interface {
	Create(user entities.User, housing entities.Housing) (string, error)
...
func (service *housingsImpl) Create(user entities.User, housing entities.Housing) (string, error) {
